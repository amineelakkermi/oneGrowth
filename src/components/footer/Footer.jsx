...
import './footer.css'
import { github, instagram, twitch } from '../../assets'
...
const Footer = () => {
  return (
    ...
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum, corporis?</p>
    ...
    <li><a href="#">794 Mcallister st</a></li>
    </ul>
    ...
    <div className='ligne' />
    <div className="footer-bottom-part-p">
    <p>Copyright @ 2023</p>
